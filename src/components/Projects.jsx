...
const ProjectCard = ({
  ...
  return (
    ...
    >
      <div
        ...
        ${active === id ? "opacity-0" : "opacity-[0.5]"}`}
      ></div>
  ...
  transition-opacity duration-[0.5s] ease-in-out ${
    showText ? "opacity-100" : "opacity-0"
          ...
          >
            ...
            <button
              ...
              whitespace-nowrap gap-1 sm:w-[110px] sm:h-[50px] 
  ...
  return (
    <div className="-mt-[6rem]">
      ...
      <div className="w-full flex">
        <motion.p className="mt-4 text-taupe text-[18px] max-w-4xl leading-[30px]">
          These selected projects showcase my expertise in engineering
          high-scale digital ecosystems to big companies. They highlight my
          ability to solve complex architectural challenges and deliver critical
          mobile solutions for global industry leaders. From banking-grade
          fintech flows at ABC Bank and Pricing B2B & B2C apps and platforms for
          EuroChem and Vibra Energia, to my award-winning app SAF Herbaria and
          App Store hits like Auway. Grounded in native (iOS/Swift) and
          cross-platform (React Native) development, my approach focuses on
          bridging technical excellence with business value to build secure,
          scalable, and highly performant user experiences.{" "}
        </motion.p>
      </div>
